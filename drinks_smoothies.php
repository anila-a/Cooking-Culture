...
<div id="box"><font size="7" face="Gabriola"><b>Drinks & Smoothies:</b></font>
<a href="newRecipe.php"><img src="img/plainicon.com-43939-512px.png" width="34.1" height="34.1" align="right"></a>
<br/>
<?php
  $query = "SELECT * FROM recipes WHERE category = 4";
...
<font size="5">
	<p><a href="soups_salads.php"><img src="img/Soup&Salad.png" width="34.5" height="34.5" border="1">   Soups & Salads</p>
	<p><a href="main_dishes.php"><img src="img/Main Dish.jpg" width="34.5" height="34.5" border="1">   Main Dishes</p>
	<p><a href="desserts.php"><img src="img/Dessert.jpg" width="34.5" height="34.5" border="1">   Desserts</p>
	<p><a href="drinks_smoothies.php"><img src="img/Drink&Smoothie.jpg" width="34.5" height="34.5" border="1" >   Drinks & Smoothies</p>
</font>
</div>
</div>
</div>
